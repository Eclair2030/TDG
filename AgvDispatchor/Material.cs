...
namespace AgvDispatchor
{
    internal class Material
    {
        ...
        public static int TOTAL_LOAD_POS_ONE_DEVICE = 300;      //一个通道的上料位总数，1个carrier 100个位置，2个robot，每个100个位置
        public static int TOTAL_MATERIAL_ONE_AREA = 40;             //一台设备的一个区域中的料总数
